...
const listadoNoticias = [
  {
    ...
    epigrafe:
      "Argentina le ganó por penales a Francia y la Copa la levanta Messi, el mejor. ¡Vamos!",
  ...
  },
  {
    ...
    epigrafe:
      "El presidente de China, Xi Jinping, llegó al Palacio del Elíseo de París, en Francia, para una reunión trilateral con el presidente de Francia.",
...
function renderizandoElementos() {
  ...
  for (let index = 0; index < listadoNoticias.length; index++) {
    const element = listadoNoticias[index];
    // por cada noticia añadir plantilla literal
    main.innerHTML += `
        <article>
